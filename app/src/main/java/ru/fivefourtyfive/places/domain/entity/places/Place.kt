...
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.DESCRIPTION
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.DISTANCE
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.IS_BUILDING
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.IS_DELETED
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.IS_PROTECTED
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.IS_REGION
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.LANGUAGE_ID
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.LANGUAGE_ISO
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.LANGUAGE_NAME
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.LOCATION
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.NAME
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.OBJECT_TYPE
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.PARENT_ID
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.PHOTOS
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.PL
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.POLYGON
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.SQUARE
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.TAGS
import ru.fivefourtyfive.places.domain.entity.util.PlaceFields.TITLE

...
package ru.fivefourtyfive.wikimapper.framework.datasource.implementation.remote.util
...
object Function {
    ...
    const val CATEGORY_GET_BY_ID    = "category.getbyid"
...
/** Main block fields are:
    "id", "object_type", "language_id", "language_iso","language_name", "urlhtml", "title",
    "description", "is_building", "is_region", "is_deleted", "tags", "parent_id", "x", "y", "pl" */
object DataBlock {
    const val MAIN                  = "main"

package ru.fivefourtyfive.wikimapper.framework.datasource.local.database.typeconverter

import androidx.room.TypeConverter
import ru.fivefourtyfive.wikimapper.framework.datasource.local.database.typeconverter.util.CoordinateDelimiters.VALUE_DELIMITER
import ru.fivefourtyfive.wikimapper.framework.datasource.local.database.typeconverter.util.CoordinateDelimiters.COORDINATE_DELIMITER

...
7.  Сделать удобное масштабирование при переходе в "режим навигатора" и обратно.
...
12. Добавить возможность масштабировать карту в режиме навигатора.
13. Не кидать запросы в викимапию и очищать (либо скрывать - решить как лучше) folder при слишком маленьих значениях Zoom-а.

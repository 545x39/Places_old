...
import ru.fivefourtyfive.wikimapper.framework.datasource.local.database.typeconverter.PolygonConverter
import ru.fivefourtyfive.wikimapper.framework.datasource.local.database.util.TableName.TABLE_PLACES
